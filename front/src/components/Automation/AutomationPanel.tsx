...
const SCOPE_TEXT: Record<AutomationScope, { title: string; subtitle: string; empty: string }> = {
  crm: {
    title: "Роботы в CRM",
    subtitle:
      "Автоматизация CRM: роботы отправляют сообщения и создают задачи, а триггеры отслеживают действия пользователей.",
    empty: "Выберите мероприятие, чтобы настроить автоматизацию CRM.",
  },
  planner: {
    title: "Роботы в планировщике",
    subtitle:
      "Автоматизация задач: роботы назначают действия, а триггеры следят за сроками и сменой статусов.",
    empty: "Выберите мероприятие, чтобы настроить автоматизацию задач.",
  },
  requests: {
    title: "Роботы в заявках",
    subtitle:
      "Автоматизация заявок: роботы отправляют уведомления и ссылки, а триггеры двигают заявку по стадиям.",
